...
ActiveRecord::Schema.define(version: 20180126155259) do
  ...
  create_table "deduct_percentages", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.integer "user_id"
    t.integer "order_id"
    t.decimal "deduct_percentages", precision: 30, scale: 10
  ...
  create_table "goods_types", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.string   "name"
    t.integer  "serial"
    t.string   "remark"
    t.datetime "created_at", null: false
  ...
  create_table "h_set_prices", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.decimal  "price",      precision: 30, scale: 10, default: "0.0"
    t.integer  "user_id"
    t.integer  "goods_id"
    t.datetime "created_at",                                           null: false
    t.datetime "updated_at",                                           null: false
  ...
  create_table "orders", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.decimal  "price_current",                     precision: 30, scale: 10,                     null: false
    t.integer  "count",                                                       default: 0,         null: false
    t.decimal  "total_price",                       precision: 30, scale: 10, default: "0.0",     null: false
    t.string   "status",                                                      default: "Waiting", null: false
    t.text     "account",             limit: 65535,                                               null: false
    ...
    t.decimal  "h_price_current",                   precision: 30, scale: 10
  end
  ...
  create_table "users", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    ...
    t.decimal  "deduct_percentage",      precision: 30, scale: 10
